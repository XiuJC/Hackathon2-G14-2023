...
void Player :: PlayerAttacked(double damage, double d){
	...
	switch (temp) {
		...
		case 16: case 17: case 18: case 19 : BonusRatio = 0.25;
											break;
		case 20:
			BonusRatio = 0.5;			// if the dice rolled 20, the player guarded
...
void Player :: Cursed(){					// a Curse is a boss' move that deals true damage
	double DamageTaken = MAX_Health / 10;	// equals to 10% of player's max Health.
