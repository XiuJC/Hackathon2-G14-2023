...
void storeFile(){
	...
	write << "Prologue" << endl;
	write << "	Ozen, the former warrior of the hero party, a dwarf whose name is well-known in the kingdom " << endl;
	write << "for his incredible strength. His party had successfully defeated the dragon that threatened " << endl;
	write << "the kingdom for decades. The capital was flooded with cheers when they finally ended their 8-year " << endl;
	...
	write << "curse of Lich had made it impossible for them to leave the dungeon and slowly corrupted the party " << endl << endl; //Paragraph 4
	//***************************************************************************************************************************
	write << "	This time, Ozen was recruited to explore the dungeon and find the missing party. Bringing his " << endl;
	write << "members. axe Sigrdr�fa and his shield Wargard, Ozen stepped on his journey towards the dungeon......";
	write.close();
	...
	write << "the devil right before your eyes right now. You can sense the rage inside its eyes...";
	write.close();
	...
	write << "and you keep on moving." << endl;
	write.close();
	...
	write << "Looking at the dying mage who used to take care of a lot of the members in the party, Ozen still could not " << endl;
	...
	write << "from the mage, one of a series of rings which was owned by each of the members in the party. Ozen is tired.\n " << endl;

	write << "He has to report the situation in the dungeon to the kingdom guards waiting outside. He steps on his feet. " << endl;
	write << "It had been a long time since the last time he experienced such heavy steps. The fatigue exhausts him. " << endl;
	write << "He never thought that the way back would be so long that he can�t feel himself getting close to exit......\n" << endl;
	write.close();
	...
	write << "Baryard: Sorry, fathe...... I still cannot...... make you prou......" << endl << endl;

	write << "Without finishing his last word, the young warrior leaves the old warrior alone in the sanctuary. A drop " << endl;
	write << "of tear runs down his face. He stares at the familiar face, holding his hand tightly but stays in silence.\n" << endl;
	...
	write << "Instead of leaving the dungeon to report the situation, Ozen decides to take a rest first. He is already " << endl;
	write << "tired of the battles and killings. He takes a nap, hoping there will be no burdens when he awakes next time.......";
	write.close();
	...
	write << "Ozen: You must be having a tough time, huh ? " << endl << endl;

	write << "The quiet dwarf says while picking him up. " << endl;
	write << "Ozen: Need some help?\n Ozen stands in front of Faust, staring at his face. " << endl << endl;

	write << "Faust : You... old cruel stubborn dwarf...\n\n The hero can barely stand up this time. " << endl << endl;

	write << "Ozen : You are gonna be asked about all this mess. Do not waste my time, we have to leave this place.\n " << endl;

	write << "Faust : Ehh... Why I have to meet that troublesome old man again? Hey Ozen, take me along with you, " << endl;
	write << "        just anywhere except the Palace. You have to be responsible for all these wounds. \n" << endl;
